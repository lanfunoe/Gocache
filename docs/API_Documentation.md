...
```json
{
  "data": {
    ...
    "fx_nickname": "示例用户678",
    "kq_talent": 0,
    "pic": "http://example.com/****icon/165/xxxxxxxx/xxxxxxxxxxxxxxxxxxxxxx.jpg",
    "k_pic": "http://example.com/****icon/165/xxxxxxxx/xxxxxxxxxxxxxxxxxxxxxx.jpg",
    "fx_pic": "http://example.com/****icon/165/xxxxxxxx/xxxxxxxxxxxxxxxxxxxxxx.jpg",
    "gender": 1,
    "vip_type": 0,
    "m_type": 0,
    "y_type": 0,
    ...
    "info": [
      {
        "tags": "",
        "status": 1,
        "create_user_pic": "http://example.com/****icon/165/xxxxxxxx/xxxxxxxxxxxxxxxxxxxxxx.jpg",
        "per_num": 0,
        "pub_new": 0,
        "is_drop": 0,
...
```json
{
    "data": {
        ...
        "list_info": {
            ...
            "tags": "学习,工作,治愈",
            "status": 1,
            "create_user_pic": "http://example.com/****icon/165/20240905/example.jpg",
            "is_pri": 0,
            "pub_new": 1,
            "is_drop": 0,
...
```json
{
  "data" : {
    ...
    "special_list" : [ {
      ...
      "play_count" : 1033673,
      "pic" : "http://example.com/****icon/165/20200731/20200731234154226414.jpg",
      "from_hash" : "",
      "from_tag" : 0,
