...
public class SongRepositoryImpl extends AbstractCompositeKeyQuerySupport<Song, SongHashId>
    ...
    public Flux<Song> findAllIn(Iterable<Song> songs) {
        ...
        final Map<String, Function<Song, Object>> fieldGetters = Map.ofEntries(
            ...
            Map.entry("hash128", Song::getHash128),
            Map.entry("hash320", Song::getHash320),
    ...
    public Mono<Long> upsert(List<Song> songs) {
        ...
        String sql = """
            INSERT INTO song (hash, audio_id, mixsongid, songname, audio_name,
                             ...
                             remark, privilege, mvhash, hash128, hash320, hash_flac,
            ...
            ON CONFLICT (hash, audio_id) DO UPDATE SET
                ...
                hash128 = EXCLUDED.hash128,
                hash320 = EXCLUDED.hash320,
